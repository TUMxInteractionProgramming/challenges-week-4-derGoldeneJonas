...
function switchChannel(channelName) {
    ...
    var iconstar = (channelName.starred)? 'fas' : 'far'


    /* #6 #liking channels on #click */
    $('#channel-star').toggleClass(iconstar +" fa-star");
...
/* #6 Current Location defining */

var currentLocation = {longitude: 9.4910 , latidude: 51.2993, what3words: "///lofts.mason.confused"}
